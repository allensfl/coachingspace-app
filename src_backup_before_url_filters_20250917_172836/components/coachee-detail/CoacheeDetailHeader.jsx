...
import { Save, X, Edit, Trash2, Link, RefreshCw } from 'lucide-react';
import { useToast } from '@/components/ui/use-toast';
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "@/components/ui/alert-dialog";

export default function CoacheeDetailHeader({ coachee, isEditing, onEditToggle, onSave, onCancelEdit, onDelete, onGeneratePortalLink }) {
        ...
        {isEditing ? (
          ...
          <>
            ...
            <div className="flex rounded-md border border-input">
              <Button variant="outline" onClick={handleCopyPortalLink} className="rounded-r-none border-r-0">
                <Link className="mr-2 h-4 w-4" /> Portal-Link
              </Button>
              <Button variant="outline" size="icon" onClick={onGeneratePortalLink} className="rounded-l-none">
