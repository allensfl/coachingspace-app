...
const mockDocuments = [
  { 
    ...
    name: "Persönlichkeitstest-Auswertung.pdf", 
    type: "assessment",
    format: "PDF",
    size: "2.1 MB",
    uploadDate: "2024-01-15T09:30:00", 
    description: "DISC Persönlichkeitstest Ergebnisse und Interpretation",
    isShared: true
  },
  { 
    id: 2, 
    ...
    name: "Work-Life-Balance-Plan.docx", 
    type: "plan",
    format: "DOCX",
    size: "850 KB",
    uploadDate: "2024-01-20T14:15:00", 
    description: "Persönlicher Aktionsplan für bessere Work-Life-Balance",
    isShared: false
  },
  { 
    id: 3, 
    coacheeId: 1, 
    coacheeName: "Anna Schmidt", 
    name: "Führungskräfte-Feedback-360.xlsx", 
    type: "feedback",
    format: "XLSX",
    size: "1.5 MB",
    uploadDate: "2024-01-25T11:20:00", 
    description: "360-Grad-Feedback von Team und Vorgesetzten",
    isShared: true
  },
  { 
    id: 4, 
    ...
    name: "Konfliktlösungs-Strategien.pptx", 
    type: "presentation",
    format: "PPTX",
    size: "3.2 MB",
    uploadDate: "2024-02-01T16:45:00", 
    description: "Präsentation über verschiedene Konfliktlösungsansätze",
    isShared: false
  },
  { 
    id: 5, 
    coacheeId: 1, 
    coacheeName: "Anna Schmidt", 
    name: "Zielvereinbarung-Q1-2024.pdf", 
    type: "agreement",
    format: "PDF",
    size: "680 KB",
    uploadDate: "2024-02-05T10:00:00", 
    description: "Quartalsziele und Meilensteine für Q1 2024",
    isShared: true
  }
];
...
export default function Documents() {
  ...
  const filteredDocuments = useMemo(() => {
    ...
    if (coacheeFilter) {
      filtered = filtered.filter(doc => doc.coacheeId === parseInt(coacheeFilter));
    }
